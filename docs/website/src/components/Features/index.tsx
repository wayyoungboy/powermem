...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'feature.developer.desc': 'Provides a simple Python SDK, automatically loads configuration from .env files, enabling developers to quickly integrate into existing projects',
  ...
  zh: {
    ...
    'feature.developer.en': 'Developer Friendly',
    'feature.developer.desc': '提供简单的 Python SDK，自动从 .env 文件加载配置，使开发者能够快速集成到现有项目中',
