...
一方集成，为现有的 AI 客户端和 IDE 提供持久记忆——所有客户端都指向相同的后端，无需每个客户端的模式重写。

- **[生态系统集成](../integrations/overview.md)** - 所有 AI 客户端和 IDE 集成的概览
- **[Claude Code](../integrations/claude_code.md)** - `memory-powermem` 插件：通过钩子实现静默 HTTP 模式捕获，可选 MCP 模式用于聊天工具

## 其他说明 {#other-notes}

- **[其他说明](1000-other_notes.md)** - 重要说明和使用指南

## 快速导航 {#quick-navigation}

- **新手？** 从 [入门指南](./0001-getting_started.md) 开始
- **需要设置？** 阅读 [配置指南](./0003-configuration.md)
- **Multi-Agent？** 查看 [Multi-Agent 指南](./0005-multi_agent.md)
- **高级功能？** 查看 [子存储指南](./0006-sub_stores.md)
